...
> 🦢 **紫天鹅 v3.0 · 绝世神品** — 记忆、执行、审视、进化、画像五位一体元核心
>
> 本仓库是 OpenClaw 的终极增强 Fork，已深度集成以下能力：
>
> - **语义向量记忆** (LanceDB)：基于余弦相似度的语义检索，理解"善意取得"与"物权法"的深层关联
>
> - **自我进化引擎** (EvoSkills)：从执行失败中自动分析、生成并固化新技能
>
> - **跨会话用户画像** (USER.md/PROJECT.md)：持续学习用户偏好、风格和项目背景
>
> - **行动前反思** (MIRROR)：在执行高风险任务前自动进行逻辑预检
>
> - **自我修正闭环**：评估不达标时自动重写并重新评估，直到质量合格
>
> **关联项目**：
>
